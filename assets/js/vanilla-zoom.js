...
/////////////////////
/*when transfer dropdown clicked toggle hide and show content*/
function transferFunction() {
  document.getElementById("myTransfer").classList.toggle("show");
}

// Close the  transfer dropdown menu if the user clicks outside of it
window.onclick = function(event) {
  if (!event.target.matches('.form-control')) {
    var dropdowns = document.getElementsByClassName("transfer-dropdown-content");
    var i;
...
//when continue button clicked in Transfer Funds  and Make Payment pages
document.getElementById("continue").addEventListener("click", continueButton);

function continueButton(){
    document.getElementById("payment_successful").innerHTML = "Payment Successful!";
}

//when print button clicked in Print Transaction page
function printButton(){
    document.getElementById("print_successful").innerHTML = "Transaction Statement printed!";
}

//when send button clicked in Contact Us page
function sendButton(){
